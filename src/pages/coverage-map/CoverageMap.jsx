...
import LoadingSpinner, { DotsLoader } from "../../components/LoadingSpinner.jsx";
import {
    BarChart,
    Bar,
    PieChart,
...
const CoverageMap = () => {
    ...
    const totalDecorators = filteredDivisions?.reduce(
        (sum, div) => sum + div?.decorators,
        0
    );
    const totalBookings = filteredDivisions?.reduce(
        (sum, div) => sum + div?.activeBookings,
        0
    );
    const avgGrowth = (
        filteredDivisions?.reduce((sum, div) => sum + div?.growth, 0) /
    ...
    if (isLoading) {
        return (
            <LoadingSpinner
                fullScreen
                message="Loading Coverage Map Analytics..."
            />
        );
    }
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
                ...
                >
                    ...
                    >
                        Interactive visualization of service coverage across
                        Bangladesh
                    </motion.p>
                </motion.div>
                            ...
                            >
                                ...
                                >
                                    <p className="text-sm text-muted-foreground text-center">
                                        <strong>Note:</strong> Green pins 📌
                                        indicate areas where our decoration
                                        services are actively available. Click
                                        on any division below for detailed
