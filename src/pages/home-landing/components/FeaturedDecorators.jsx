    ...
    const decorators = [
        {
            ...
            imageAlt:
                "Professional portrait of Bangladeshi woman decorator with warm smile wearing elegant traditional attire and modern accessories",
        ...
        },
        {
            ...
            imageAlt:
                "Professional headshot of Bangladeshi male decorator with confident expression wearing formal business attire and glasses",
        ...
        },
        {
            ...
            image: "https://img.rocket.new/generatedImages/rocket_gen_img_10fb083fa-1763296324852.png",
            imageAlt:
                "Professional portrait of young Bangladeshi woman decorator with creative expression wearing contemporary outfit and artistic jewelry",
        ...
        },
        {
            ...
            imageAlt:
                "Professional headshot of experienced Bangladeshi male decorator with friendly demeanor wearing traditional formal wear",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                        Meet our top-rated decoration professionals trusted by
                        hundreds of satisfied clients across Bangladesh
                    </p>
                </div>
