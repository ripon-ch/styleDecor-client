...
export default function CustomerDashboard() {
  ...
  const loadBookings = async () => {
    ...
    setError('');
    try {
      const data = await bookingService?.getAll(user?.id, 'customer');
      setBookings(data);
    } catch (err) {
  ...
  const bookingHistory = completedBookings;
  ...
  const upcomingAppointments = [
    {
      id: 1,
      serviceName: "Wedding Stage Decoration",
      serviceImage: "https://images.unsplash.com/photo-1629222061513-6153477c7f2f",
      serviceImageAlt: "Elegant wedding stage with white and gold floral arrangements",
      date: "15/12/2025",
      time: "10:00 AM",
      daysUntil: 9
    },
    {
      ...
      serviceImage: "https://images.unsplash.com/photo-1641152298090-5d88769d4fc7",
  ...
  const recommendedServices = [
    {
      ...
      imageAlt: "Beautiful engagement ceremony decoration with floral arrangements and elegant seating",
      rating: 4.7,
      price: 28000
    },
    {
      ...
      imageAlt: "Festive housewarming decoration with traditional elements and modern touches",
      rating: 4.6,
      price: 15000
    },
    {
      ...
      imageAlt: "Vibrant festival decoration with colorful lights and traditional ornaments",
      rating: 4.8,
      price: 20000
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
        <DashboardHeader userName={userData?.fullName} userEmail={userData?.email} />
