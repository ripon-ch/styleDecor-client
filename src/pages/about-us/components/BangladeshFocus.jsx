...
const BangladeshFocus = () => {
  ...
  const regionalExpertise = [
  {
    ...
    description: 'Deep knowledge of regional decoration preferences and cultural nuances across Bangladesh.'
  },
  {
    icon: 'Globe',
    title: 'Cultural Sensitivity',
    description: 'Respecting and celebrating diverse cultural traditions in decoration services nationwide.'
  },
  {
    icon: 'TrendingUp',
    title: 'Regional Expertise',
    description: 'Specialized decorators familiar with local events, ceremonies, and decoration styles.'
  }];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Bringing professional decoration services to every corner of our beautiful nation
          </p>
        </motion.div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="flex items-center gap-3 bg-card/90 backdrop-blur-sm rounded-lg p-4">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">All 64 Districts</p>
                    <p className="text-sm text-muted-foreground">Complete Nationwide Coverage</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.div
          ...
          <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            We're more than a service platform – we're a community of passionate Bangladeshis working together to elevate decoration standards nationwide. Every booking supports local decorators and their families, contributing to economic growth in communities across our country.
          </p>
        </motion.div>
      </div>
    </section>);
